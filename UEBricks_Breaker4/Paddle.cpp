...
//// Si la posición actual del paddle excede alguno de los límites, establece la posición del paddle en el límite correspondiente
//if (CurrentLocation.Z > currentV)
//{
//	CurrentLocation.Z = currentV;
//}
//if (CurrentLocation.Z < -currentV)
//{
//	CurrentLocation.Z = -currentV;
